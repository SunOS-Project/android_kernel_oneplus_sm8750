...
ext-mod-dirs := $(ext-mod-dir)/qcom/opensource/audio-kernel $(ext-mod-dir)/qcom/opensource/display-drivers $(ext-mod-dir)/qcom/opensource/video-kernel $(ext-mod-dir)/nxp/opensource/driver $(ext-mod-dir)/st/opensource/driver $(ext-mod-dir)/st/opensource/eSE-driver
